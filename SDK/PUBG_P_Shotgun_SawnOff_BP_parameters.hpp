...
struct AP_Shotgun_SawnOff_BP_C_SetParticleParameter_Params
{
...
struct AP_Shotgun_SawnOff_BP_C_OnParticleFinish_Params
{
...
struct AP_Shotgun_SawnOff_BP_C_OnParticleCollide_Params
{
...
struct AP_Shotgun_SawnOff_BP_C_OnParameterUpdated_Params
{
};

// Function TslGame.TslParticle.GetParticleParamter
struct AP_Shotgun_SawnOff_BP_C_GetParticleParamter_Params
{
	class FString*                                     Name;                                                     // (Parm, ZeroConstructor)
...
struct AP_Shotgun_SawnOff_BP_C_GetEmitterGlobalSpawnRateScale_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function TslGame.TslParticle.ForceSpawn
struct AP_Shotgun_SawnOff_BP_C_ForceSpawn_Params
{
...
struct AP_Shotgun_SawnOff_BP_C_AttachToParent_Params
{
};
