...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData03 : 3;                                        // 0x0076(0x0001)
	...
	unsigned char                                      UnknownData07[0x14];                                      // 0x00BC(0x0014) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x2C];                                      // 0x00FC(0x002C) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0xF8];                                      // 0x013C(0x00F8) MISSED OFFSET
	...
	unsigned char                                      UnknownData10[0x8];                                       // 0x0238(0x0008) MISSED OFFSET
};
...
struct FMinimalViewInfo
{
	...
	struct FPostProcessSettings                        PostProcessSettings;                                      // 0x0010(0x0530) (BlueprintVisible)
	float                                              OrthoWidth;                                               // 0x0540(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bConstrainAspectRatio : 1;                                // 0x0544(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseFieldOfViewForLOD : 1;                                // 0x0544(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0545(0x0003) MISSED OFFSET
	struct FRotator                                    Rotation;                                                 // 0x0548(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              OrthoNearClipPlane;                                       // 0x0554(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x0558(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
	struct FVector                                     Location;                                                 // 0x0560(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              FOV;                                                      // 0x056C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECameraProjectionMode>                 ProjectionMode;                                           // 0x0570(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0571(0x0003) MISSED OFFSET
	float                                              PostProcessBlendWeight;                                   // 0x0574(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OrthoFarClipPlane;                                        // 0x0578(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FPrimaryAssetTypeInfo
{
	...
	TArray<class FString>                              AssetScanPaths;                                           // 0x0068(0x0010) (ZeroConstructor, Transient)
...
{
	class FString                                      LayerName;                                                // 0x0000(0x0010) (Edit, ZeroConstructor)
...
struct FSkeletalMeshLODInfo
{
	...
	class FString                                      SourceImportFilename;                                     // 0x04F8(0x0010) (Edit, ZeroConstructor, EditConst)
...
{
	class FString                                      TerminalCategory;                                         // 0x0000(0x0010) (ZeroConstructor)
	class FString                                      TerminalSubCategory;                                      // 0x0010(0x0010) (ZeroConstructor)
...
struct FPredictProjectilePathParams
{
	...
	TEnumAsByte<ECollisionChannel>                     TraceChannel;                                             // 0x0026(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0027(0x0001) MISSED OFFSET
	struct FName                                       TraceProfile;                                             // 0x0028(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<TEnumAsByte<EObjectTypeQuery>>              ObjectTypes;                                              // 0x0030(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class AActor*>                              ActorsToIgnore;                                           // 0x0040(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              SimFrequency;                                             // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OverrideGravityZ;                                         // 0x0054(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EDrawDebugTrace>                       DrawDebugType;                                            // 0x0058(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.GameViewport
	TArray<struct FNamedNetDriver>                     ActiveNetDrivers;                                         // 0x0008(0x0010) (ZeroConstructor, Transient)
	struct FURL                                        LastRemoteURL;                                            // 0x0018(0x0070)
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x0088(0x0010) (ZeroConstructor)
	...
	unsigned char                                      UnknownData02[0xD8];                                      // 0x00C8(0x00D8) MISSED OFFSET
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x01A0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x28];                                      // 0x01B0(0x0028) MISSED OFFSET
	TArray<struct FLevelStreamingStatus>               PendingLevelStreamingStatusUpdates;                       // 0x01D8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x10];                                      // 0x01E8(0x0010) MISSED OFFSET
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x01F8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x10];                                      // 0x0208(0x0010) MISSED OFFSET
	unsigned char                                      UnknownData06[0x8];                                       // 0x0208(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.OwningGameInstance
	struct FURL                                        LastURL;                                                  // 0x0220(0x0070)
	unsigned char                                      UnknownData07[0x10];                                      // 0x0290(0x0010) MISSED OFFSET
};
...
{
	TMap<class FString, struct FMeshSectionInfoMap>    Map;                                                      // 0x0000(0x0050) (ZeroConstructor)
};
...
struct FBPVariableDescription
{
	...
	class FString                                      FriendlyName;                                             // 0x0098(0x0010) (Edit, ZeroConstructor)
	...
	class FString                                      DefaultValue;                                             // 0x00E8(0x0010) (Edit, ZeroConstructor)
};
