...
struct FMinimalViewInfo
{
	...
	float                                              OrthoFarClipPlane;                                        // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Location;                                                 // 0x0008(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              OrthoWidth;                                               // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECameraProjectionMode>                 ProjectionMode;                                           // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	float                                              AspectRatio;                                              // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x0020(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
	float                                              PostProcessBlendWeight;                                   // 0x0028(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FRotator                                    Rotation;                                                 // 0x0034(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	TArray<struct FLevelStreamingStatus>               PendingLevelStreamingStatusUpdates;                       // 0x0008(0x0010) (ZeroConstructor)
	TArray<struct FNamedNetDriver>                     ActiveNetDrivers;                                         // 0x0018(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	unsigned char                                      UnknownData02[0x8];                                       // 0x0028(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.GameViewport
	struct FURL                                        LastURL;                                                  // 0x0038(0x0070)
	unsigned char                                      UnknownData03[0x18];                                      // 0x00A8(0x0018) MISSED OFFSET
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x00C0(0x0010) (ZeroConstructor)
	struct FURL                                        LastRemoteURL;                                            // 0x00D0(0x0070)
	unsigned char                                      UnknownData04[0x50];                                      // 0x0140(0x0050) MISSED OFFSET
	class UPendingNetGame*                             PendingNetGame;                                           // 0x0190(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC8];                                      // 0x0198(0x00C8) MISSED OFFSET
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x0260(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0270(0x0010) MISSED OFFSET
	unsigned char                                      UnknownData07[0x8];                                       // 0x0270(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.OwningGameInstance
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x0288(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0298(0x0008) MISSED OFFSET
};
