...
void UUiReplayList_C::UpdateReplayList_Impl(class FString* RegionOrLocal)
{
...
void UUiReplayList_C::SetReplayItemToProcess(class FString* RegionOrLocal, struct FReplayItem* inReplayItem)
{
...
void UUiReplayList_C::UpdateReplayList__DelegateSignature(class FString* RegionOrLocal)
{
