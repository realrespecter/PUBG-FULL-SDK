...
void UWebPopup_C::SetPopupData(class FString* PopupId, class FString* Uri, bool* UseBackgroundColor, struct FLinearColor* BackgroundColor, bool* bShowButtonGroup)
{
...
void UWebPopup_C::BndEvt__WebView_K2Node_ComponentBoundEvent_18_UIGTFinishLoadSignature__DelegateSignature(class FString* path, bool* isMainFrame)
{
...
void UWebPopup_C::BndEvt__WebView_K2Node_ComponentBoundEvent_49_UIGTStartLoadingSignature__DelegateSignature(class FString* path, bool* isMainFrame)
{
...
void UWebPopup_C::BndEvt__WebView_K2Node_ComponentBoundEvent_67_UIGTFailLoadSignature__DelegateSignature(class FString* path, class FString* Error, bool* isMainFrame)
{
