...
public:
	...
	FPointer                                           Vtable;                                                   // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	int32_t                                            ObjectFlags;                                              // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	int32_t                                            ss;                                                       // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	...
	{
		__int64 decryption_Result;
		uint64_t BaseAdress = reinterpret_cast<uint64_t>(GetModuleHandleA(nullptr));

		auto objects_Encrypted = *(uint64_t*)((baseAdress + GObjects) + 0x10);
		LODWORD(decryption_Result) = (objects_Encrypted + 0x6B0B5FA5) ^ 0x6B0B5FA5;
		HIDWORD(decryption_Result) = (HIDWORD(objects_Encrypted) - 360387899) ^ 0x157B153B;
...
public:
	...
	unsigned char                                      pad_0038[88];                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	class UField*                                      Children;                                                 // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_0098[52];                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	int32_t                                            PropertySize;                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_00D0[8];                                              // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
// 0x01D0 (0x02B8 - 0x00E8)
class UClass : public UStruct
{
public:
	unsigned char                                      UnknownData00[0x1D0];                                     // 0x00E8(0x01D0) MISSED OFFSET
...
{
public:
	int16_t                                            FunctionFlags;                                            // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	int16_t                                            RepOffset;                                                // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_00DC[52];                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_011C[12];                                             // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData00[0x1A0];                                     // 0x0138(0x01A0) MISSED OFFSET
