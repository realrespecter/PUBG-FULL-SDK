...
void UBP_FppWeaponListSlotWidget_C::On_SlotNumberText_Prepass_1(class UWidget** BoundWidget)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_FppWeaponListSlotWidget.BP_FppWeaponListSlotWidget_C.On_SlotNumberText_Prepass_1");

	UBP_FppWeaponListSlotWidget_C_On_SlotNumberText_Prepass_1_Params params;
