...
// Function InventorySlotBaseWidget.InventorySlotBaseWidget_C.IsApplySkinMode
// ()
// Parameters:
// bool                           bIsApplySkinMode               (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UInventorySlotBaseWidget_C::IsApplySkinMode(bool* bIsApplySkinMode)
{
	static auto fn = UObject::FindObject<UFunction>("Function InventorySlotBaseWidget.InventorySlotBaseWidget_C.IsApplySkinMode");

	UInventorySlotBaseWidget_C_IsApplySkinMode_Params params;
...
// Function InventorySlotBaseWidget.InventorySlotBaseWidget_C.IsClearSkinMode
// ()
// Parameters:
// bool                           bIsClearSkinMode               (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UInventorySlotBaseWidget_C::IsClearSkinMode(bool* bIsClearSkinMode)
{
	static auto fn = UObject::FindObject<UFunction>("Function InventorySlotBaseWidget.InventorySlotBaseWidget_C.IsClearSkinMode");

	UInventorySlotBaseWidget_C_IsClearSkinMode_Params params;
...
void UInventorySlotBaseWidget_C::OnLeaveSlot__DelegateSignature(TScriptInterface<class USlotInterface>* Slot, TScriptInterface<class USlotContainerInterface>* SlotContainer)
{
...
void UInventorySlotBaseWidget_C::OnEnterSlot__DelegateSignature(TScriptInterface<class USlotInterface>* Slot, TScriptInterface<class USlotContainerInterface>* SlotContainer)
{
