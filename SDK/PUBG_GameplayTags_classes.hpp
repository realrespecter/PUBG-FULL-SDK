...
{
public:
	class FString                                      UserDescription;                                          // 0x0030(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
...
{
public:
	class FString                                      ConfigFileName;                                           // 0x0030(0x0010) (ZeroConstructor)
...
{
public:
	class FString                                      DeveloperConfigName;                                      // 0x0030(0x0010) (Edit, ZeroConstructor, Config)
