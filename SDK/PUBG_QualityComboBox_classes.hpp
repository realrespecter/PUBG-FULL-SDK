...
public:
	...
	void ClearOptions();
	void AddOption(const class FString& OptionName, const struct FText& DisplayOptionName);
	void BndEvt__ComboBox_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature(const class FString& SelectedItem, TEnumAsByte<ESelectInfo> SelectionType);
	void ExecuteUbergraph_QualityComboBox(int EntryPoint);
	void OnSelectionChanged__DelegateSignature(const class FString& SelectedItem, TEnumAsByte<ESelectInfo> SelectionType);
};
