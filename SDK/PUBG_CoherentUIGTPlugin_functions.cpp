...
void UCoherentUIGTBlueprintFunctionLibrary::STATIC_TriggerJSEvent(class UCoherentUIGTBaseComponent** Component, class FString* EventName, class UCoherentUIGTJSEvent** JSEvent)
{
...
void UCoherentUIGTBlueprintFunctionLibrary::STATIC_AddString(class UCoherentUIGTJSEvent** JSEvent, class FString* Arg)
{
