...
void UAkGameplayStatics::STATIC_UnloadBank(class UAkAudioBank** Bank, class FString* BankName)
{
...
class UAkComponent* UAkGameplayStatics::STATIC_SpawnAkComponentAtLocation(class UObject** WorldContextObject, class UAkAudioEvent** AkEvent, struct FVector* Location, struct FRotator* Orientation, bool* AutoPost, class FString* EventName, bool* AutoDestroy)
{
...
void UAkGameplayStatics::STATIC_PostEventByName(class FString* EventName, class AActor** Actor, bool* bStopWhenAttachedToDestroyed)
{
...
int UAkGameplayStatics::STATIC_PostEventAttached(class UAkAudioEvent** AkEvent, class AActor** Actor, struct FName* AttachPointName, bool* bStopWhenAttachedToDestroyed, class FString* EventName)
{
...
void UAkGameplayStatics::STATIC_PostEventAtLocationByName(class FString* EventName, struct FVector* Location, struct FRotator* Orientation, class UObject** WorldContextObject)
{
...
int UAkGameplayStatics::STATIC_PostEventAtLocation(class UAkAudioEvent** AkEvent, struct FVector* Location, struct FRotator* Orientation, class FString* EventName, class UObject** WorldContextObject)
{
...
int UAkGameplayStatics::STATIC_PostEvent(class UAkAudioEvent** AkEvent, class AActor** Actor, bool* bStopWhenAttachedToDestroyed, class FString* EventName)
{
...
void UAkGameplayStatics::STATIC_LoadBank(class UAkAudioBank** Bank, class FString* BankName)
{
