...
{
public:
	bool                                               bPendingUpdateSkeletalMesh;                               // 0x0490(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0491(0x0003) MISSED OFFSET
	float                                              SkippedLastRenderTime;                                    // 0x0494(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UCustomizableObjectInstance*                 CustomizableObjectInstance;                               // 0x0498(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	void SetProjectorValue(const class FString& ProjectorParamName, float posX, float posY, float posZ, float dirX, float dirY, float dirZ, float upX, float upY, float upZ, float ScaleX, float ScaleY, float ScaleZ, float Angle, ECustomizableObjectProjectorType ProjectionType);
	void SetProjectorParameterType(const class FString& ParamName, ECustomizableObjectProjectorType Type);
	void SetIntParameterSelectedOption(const class FString& ParamName, const class FString& SelectedOptionName);
	void SetFloatParameterSelectedOption(const class FString& FloatParamName, float FloatValue);
	...
	ECustomizableObjectProjectorType GetProjectorParameterType(const class FString& ParamName);
	class UTexture2D* GetParameterDescription(class FString* ParamName, int* DescIndex);
	class FString GetIntParameterSelectedOption(const class FString& ParamName);
	float GetFloatParameterSelectedOption(const class FString& FloatParamName);
	class FString GetCurrentState();
	bool GetBoolParameterSelectedOption(const class FString& BoolParamName);
	int FindVectorParameterNameIndex(const class FString& ParamName);
	int FindProjectorParameterNameIndex(const class FString& ParamName);
	int FindIntParameterNameIndex(const class FString& ParamName);
	int FindFloatParameterNameIndex(const class FString& ParamName);
	int FindBoolParameterNameIndex(const class FString& ParamName);
};
...
public:
	...
	class FString GetStateParameterName(const class FString& StateName, int ParameterIndex);
	int GetStateParameterCount(const class FString& StateName);
