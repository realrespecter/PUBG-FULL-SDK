...
public:
	...
	TArray<class FString>                              AutoCompleteMapPaths;                                     // 0x0048(0x0010) (Edit, ZeroConstructor, Config)
...
{
public:
	class FString                                      CompanyName;                                              // 0x0030(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      CompanyDistinguishedName;                                 // 0x0040(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      CopyrightNotice;                                          // 0x0050(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      Description;                                              // 0x0060(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      Homepage;                                                 // 0x0070(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      LicensingTerms;                                           // 0x0080(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      PrivacyPolicy;                                            // 0x0090(0x0010) (Edit, ZeroConstructor, Config)
	struct FGuid                                       ProjectID;                                                // 0x00A0(0x0010) (Edit, Config, IsPlainOldData)
	class FString                                      ProjectName;                                              // 0x00B0(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      ProjectVersion;                                           // 0x00C0(0x0010) (Edit, ZeroConstructor, Config)
	class FString                                      SupportContact;                                           // 0x00D0(0x0010) (Edit, ZeroConstructor, Config)
