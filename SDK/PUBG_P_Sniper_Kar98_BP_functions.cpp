...
void AP_Sniper_Kar98_BP_C::SetParticleParameter(class FString* Name, float* Value, bool* bEnableRTPC)
{
...
void AP_Sniper_Kar98_BP_C::OnParticleCollide(struct FName* EventName, float* EmitterTime, int* ParticleTime, struct FVector* Location, struct FVector* Velocity, struct FVector* Direction, struct FVector* Normal, struct FName* BoneName, class UPhysicalMaterial** PhysMat)
{
...
float AP_Sniper_Kar98_BP_C::GetParticleParamter(class FString* Name, float* DefaultValue)
{
...
void AP_Sniper_Kar98_BP_C::ForceSpawn(int* emitterIndex, struct FVector* InLocation)
{
