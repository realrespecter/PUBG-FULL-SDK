...
public:
	...
	TArray<class FString>                              BeginConsoleCommands;                                     // 0x0428(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	class FString                                      SaveFileName;                                             // 0x0458(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	TArray<class FString>                              StableFrameStats;                                         // 0x0518(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	TArray<class FString>                              StatNames;                                                // 0x0560(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<class FString>                              StatGroups;                                               // 0x0570(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<class FString>                              HitchFrameStats;                                          // 0x05C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	class FString                                      HtmlTemplate;                                             // 0x0680(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class FString                                      MinimapSpotTemplate;                                      // 0x0690(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<class FString>                              SpotTextArray;                                            // 0x06A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class FString                                      MinimapSpotInstance;                                      // 0x06B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<class FString>                              MinimapSpotInstanceArray;                                 // 0x06C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<class FString>                              HitchAdminMovePlayerArray;                                // 0x06E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class FString                                      LastAdminMovePlayerCommand;                               // 0x06F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	class FString                                      MinimapSpotDropdownTemplate;                              // 0x0710(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class FString                                      MinimapSpotDropdownInstance;                              // 0x0720(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<class FString>                              MinimapSpotDropdownInstanceArray;                         // 0x0730(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<class FString>                              StatNameIndex;                                            // 0x0748(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	class FString                                      MapPixelSize;                                             // 0x0770(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<class FString>                              HitchFrameStatsThreshold_Instance_To_String;              // 0x07A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	class FString GetAltSharedPresetDir();
	void GetCurrentLevelSize(float* NewParam);
	void GetExpectedMapSize(float MapStride, float* NewParam);
	class FString GetSharedPresetDir();
	class FString GetSavedDir();
	void LoadStringFromFile(const class FString& FullFilePath, bool* bSuccess, class FString* NewVar_1);
	void GetCurrentLevelMinimapURL(const class FString& PresetDir, class FString* NewParam);
	void FloatArrayToNewlinedString(const class FString& NewlinedString, TArray<float>* Array, class FString* NewVar_1);
	void StingArrayToNewlinedString(const class FString& NewlinedString, TArray<class FString>* Array, class FString* NewVar_1);
	TArray<float> HitchFrameStatsThreshold();
	void GetAvgOnArray(TArray<float>* NewParam, float* OutAvg, float* OutMin, float* OutMax);
	void DateTimeToString(const struct FDateTime& NewParam, class FString* NewParam1);
