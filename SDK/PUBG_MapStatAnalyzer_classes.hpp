...
public:
	...
	void LoadStringFromFile(class FString* FullFilePath, bool* bSuccess, class FString* NewVar_1);
	void GetCurrentLevelMinimapURL(class FString* PresetDir, class FString* NewParam);
	void FloatArrayToNewlinedString(class FString* NewlinedString, TArray<float>* Array, class FString* NewVar_1);
	void StingArrayToNewlinedString(class FString* NewlinedString, TArray<class FString>* Array, class FString* NewVar_1);
	TArray<float> HitchFrameStatsThreshold();
	void GetAvgOnArray(TArray<float>* NewParam, float* OutAvg, float* OutMin, float* OutMax);
	void DateTimeToString(struct FDateTime* NewParam, class FString* NewParam1);
