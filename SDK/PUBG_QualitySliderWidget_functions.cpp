...
struct FEventReply UQualitySliderWidget_C::OnMouseButtonDown_1(struct FGeometry* MyGeometry, struct FPointerEvent* MouseEvent)
{
...
void UQualitySliderWidget_C::ProcessKeyDown(struct FKey* Key, struct FEventReply* Reply)
{
...
void UQualitySliderWidget_C::BndEvt__EditableText_2_K2Node_ComponentBoundEvent_82_OnEditableTextChangedEvent__DelegateSignature(struct FText* Text)
{
