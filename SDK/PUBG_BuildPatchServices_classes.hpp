...
public:
	...
	class FString                                      AppName;                                                  // 0x0038(0x0010) (ZeroConstructor)
	class FString                                      BuildVersion;                                             // 0x0048(0x0010) (ZeroConstructor)
	class FString                                      LaunchExe;                                                // 0x0058(0x0010) (ZeroConstructor)
	class FString                                      LaunchCommand;                                            // 0x0068(0x0010) (ZeroConstructor)
	class FString                                      PrereqName;                                               // 0x0078(0x0010) (ZeroConstructor)
	class FString                                      PrereqPath;                                               // 0x0088(0x0010) (ZeroConstructor)
	class FString                                      PrereqArgs;                                               // 0x0098(0x0010) (ZeroConstructor)
