...
struct FVector UNewWorldMapWidget_C::ComputeServerToLocalPosition(struct FVector* Server)
{
...
void UNewWorldMapWidget_C::IsInMapWidget(struct FVector2D* Position, bool* IsIn)
{
...
void UNewWorldMapWidget_C::ClampPosition(struct FVector2D* Position, struct FVector2D* ConvertedPosition)
{
