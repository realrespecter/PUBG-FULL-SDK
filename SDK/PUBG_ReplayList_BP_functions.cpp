...
void AReplayList_BP_C::UpdateReplayList(const class FString& inRegionOrLocal)
{
...
void AReplayList_BP_C::OnItemClicked(const class FString& RegionOrLocal, const struct FReplayItem& inReplayItem)
{
