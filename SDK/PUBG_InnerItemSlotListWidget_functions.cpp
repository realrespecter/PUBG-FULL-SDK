...
void UInnerItemSlotListWidget_C::OnSlotFocus(TScriptInterface<class USlotInterface>* Slot, TScriptInterface<class USlotContainerInterface>* SlotContainer)
{
...
void UInnerItemSlotListWidget_C::OnChildSlotFocus__DelegateSignature(TScriptInterface<class USlotInterface>* Slot)
{
