...
void USelfPutHelperWidget_C::StartSelfPutItem(TScriptInterface<class USlotInterface>* Slot, TScriptInterface<class USlotContainerInterface>* Container, bool* bResult, int* StartWeaponIndex)
{
