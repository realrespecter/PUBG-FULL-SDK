...
void ULobbyWebPopupCanvs_C::ChangeWebPopupUriImpl(const class FString& PopupId, const class FString& Uri)
{
...
void ULobbyWebPopupCanvs_C::OnCloseWebPopupImpl(const class FString& PopupId)
{
...
void ULobbyWebPopupCanvs_C::CloseWebPopup(const class FString& PopupId)
{
