...
void UCS_WeapGun_Pistol_M9_C::ReceiveStopShake(bool bImmediately)
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.ReceiveStopShake");

	UCS_WeapGun_Pistol_M9_C_ReceiveStopShake_Params params;
...
void UCS_WeapGun_Pistol_M9_C::ReceivePlayShake(float* Scale)
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.ReceivePlayShake");

	UCS_WeapGun_Pistol_M9_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UCS_WeapGun_Pistol_M9_C::ReceiveIsFinished()
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.ReceiveIsFinished");

	UCS_WeapGun_Pistol_M9_C_ReceiveIsFinished_Params params;
...
void UCS_WeapGun_Pistol_M9_C::BlueprintUpdateCameraShake(float* DeltaTime, float* ALPHA, struct FMinimalViewInfo* POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.BlueprintUpdateCameraShake");

	UCS_WeapGun_Pistol_M9_C_BlueprintUpdateCameraShake_Params params;
