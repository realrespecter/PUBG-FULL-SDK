...
public:
	...
	TArray<struct FNiagaraVariable>                    EffectParameterLocalOverrides;                            // 0x0910(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNiagaraScriptDataInterfaceInfo>     EffectDataInterfaceLocalOverrides;                        // 0x0920(0x0010) (Edit, ZeroConstructor)
	TArray<class UNiagaraDataInterface*>               InstanceDataInterfaces;                                   // 0x0930(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	bool                                               bRenderingEnabled;                                        // 0x0940(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0941(0x000F) MISSED OFFSET
