...
void UTslCheckBox_C::IsToggleKey(struct FKey* Key, bool* IsToggle)
{
...
void UTslCheckBox_C::ProcessKeyDown(struct FKey* Key, struct FEventReply* Reply)
{
...
struct FEventReply UTslCheckBox_C::OnMouseButtonDown_1(struct FGeometry* MyGeometry, struct FPointerEvent* MouseEvent)
{
